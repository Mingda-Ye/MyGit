...
static char codepris[7][MAXFREQ][16]={  /* code priority table */
   ...
   /* L1/E1      L2/B1        L5/E5a/L3 L6/LEX/B3 E5b/B2    E5(a+b)  S */
    {"CPYWMNSL","PXWCMNDSLX","IQX"     ,""       ,""       ,""      ,""    }, /* GPS */ //from PYWC to PXWC,Modified by ymd, 2021.4.9
    {"PC"      ,"PC"        ,"IQX"     ,""       ,""       ,""      ,""    }, /* GLO */
    {"CABXZ"   ,""          ,"IQX"     ,"ABCXZ"  ,"IQX"    ,"IQX"   ,""    }, /* GAL */
    {"CSLXZ"   ,"SLX"       ,"IQX"     ,"SLX"    ,""       ,""      ,""    }, /* QZS */
    {"C"       ,""          ,"IQX"     ,""       ,""       ,""      ,""    }, /* SBS */
    {"IQX"     ,"IQX"       ,"IQX"     ,"IQX"    ,"IQX"    ,"IQX"   ,""    }, /* BDS */
    {""        ,""          ,"ABCX"    ,""       ,""       ,""      ,"ABCX"}  /* IRN */
};
...
extern double satwavelen(int sat, int frq, const nav_t *nav)
{
    ...
    if (sys==SYS_GLO) {
        ...
        if      (frq==0) return CLIGHT/FREQ1_CMP; /* B1-2 */
        else if (frq==1) return CLIGHT/FREQ2_CMP; /* B2b */
        else if (frq==2) return CLIGHT/FREQ3_CMP; /* B3 */
//        else if (frq==3) return CLIGHT/FREQ1; //B1c, BDS-3 signals added by ymd, 2021.4.10
//        else if (frq==4) return CLIGHT/FREQ5; //B2a
//        else if (frq==5) return CLIGHT/FREQ1; //B2
